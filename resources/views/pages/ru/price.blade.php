    ...
    <div id="price-descriptions">
      ...
      <div class="description speed ui stackable two column grid">
        ...
        <div class="column text">
          ...
          <p>
            ...
            фронтендером, тот в свою очередь с бэкендером и так далее. Я могу все сделать в одиночку и даже внутри у меня сейчас только одна
            личность - это я.
          </p>
        </div>
      </div>
      ...
      <div class="description greed ui stackable two column grid">
        ...
        <div class="column text">
          ...
          <p>Среди огромной армии заказчиков, почти все - это бедолаги, которые ищут (и не находят) - кто разберется в мешанине ребусов непонятных даже их автору, который самонадеянно взялся за дело которое не осилил и бросил.</p>
          {{--<p>Не хотелось это писать, но самонадеянные профаны - это подавляющее большинство так называемых web-разработчиков, они просятся внаем не гнушаясь демпингом, но не понимают на что идут, и платит за их самонадеянность заказчик, который так же надеялся "сэкономить".</p>--}}
          {{--<p>Исполнители надеятся справится, заказчики надеятся сэкономить. Так они находят друг друга. Но будьте реалистами - у всего есть цена</p>--}}
          <p>Расписная бумага именуемая деньгами - это обыденность доступная каждому, а за серьезными веб-разработчиками идет неустанная охота по всей Земле.</p>
        </div>
      </div>
