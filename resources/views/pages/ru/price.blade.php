    ...
    <div id="price-descriptions">
      ...
      <div class="description total ui stackable two column grid">
        <div class="column text">
          ...
          <p>Минимальная стоимость проекта - 300 000 рублей. Это связано с тем, что с каждым заказчиком
            необходимо
            отдельно налаживать взаимопонимание и совместную работу.</p>

          <p>За 300 000 рублей я смогу сделать рабочий сайт, решающий поставленные задачи. Например,
            Интернет-магазин с
