...
@section('content')
  <div class="ui page container" id="price">
    ...
    <div class="notice">
      <em>* хотя это честная цена для России и демпинговая для Запада, я могу сделать скидку, если у тебя проблемы
        с деньгами, а твой проект должен помочь людям и при этом у меня есть сейчас такая возможность.</em>
    </div>
    ...
    <div id="price-descriptions">
      ...
      <div class="description total ui stackable two column grid">
        <div class="column text">
          ...
          <p>За 100 000 рублей я смогу сделать рабочий сайт решающий поставленные задачи, например
            ...
            дизайном на базе
            <a href="https://semantic-ui.com/">Semantic UI</a>, <a href="https://getbootstrap.com/">Twitter Bootstrap</a> или <a href="https://github.com/thoughtbot/bourbon">Bourbon.io</a></p>
      ...
      <div class="description greed ui stackable two column grid">
        ...
        <div class="column text">
          ...
          <p>Сайты моего уровня могут разработать и реализовать лишь доля процента людей по всему миру, а резаная бумага
            есть у всех стандартных людей на Земле.</p>
          <p>Если ты веришь в дешевые сайты, то тебе еще рано работать со мной.</p>
          <p>Если ты не веришь, что можно сделать очень качественный сайт очень быстро, и не иметь с ним проблем, то плати много, постоянно и до бесконечности как ты привык это делать, а меня не отвлекай.</p>
          <p>Если ты очень умный - сделай сам себе сайт бесплатно, заодно может научишься хоть чему-то действительно полезному.</p>
        </div>
      </div>
