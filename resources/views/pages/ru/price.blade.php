...
@section('content')
    <div class="ui page container" id="price">
                            ...
                            <svg id="clock" width="163px" height="163px" viewBox="0 0 163 163" version="1.1"
                                ...
                                <defs>
                                    ...
                                    <mask id="mask-10" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-9"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-12" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-11"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-14" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-13"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-16" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-15"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-18" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-17"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-20" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-19"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-22" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-21"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-24" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                          x="0"
                                          y="0" width="4" height="12" fill="white">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-23"></use>
                                    </mask>
                                    ...
                                    <mask id="mask-30" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox"
                                        ...
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#path-28"></use>
                                    </mask>
                                </defs>
                                <g id="Artboards" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Large-Monitor---Process-Copy"
                                                ...
                                                <g id="adminoid/elements/clocks-original">
                                                    <g id="clock">
                                                        <circle id="pie-circle" r="40" cx="-80.1186223" cy="80.1854528"
                                                                fill="none" transform="rotate(-90)" stroke="#CD2E41"
                                                                stroke-width="80" stroke-dasharray="0 251"></circle>
        ...
        <div class="notice">
            * хотя это честная цена для России и демпинговая для Запада, я сделаю скидку, если у тебя проблемы
            с деньгами, а твой проект должен помочь людям и при этом у меня есть сейчас такая возможность. Так что пиши.
        </div>
        ...
        <div id="price-descriptions">
            ...
            <div class="description tomato ui stackable two column grid">
                ...
                <div class="column text">
                    ...
                    <p>Я работаю строго по таймеру, если нужно, например, почту проверить или отойти от ноутбука -
                        ставлю таймер
                        на паузу.</p>

                    <p>Это не просто таймер, а техника <span id="pomodoro">Pomodoro <img
                                    src="/static/img/adminoid/pages/price/span-tomato.png" alt=""></span> +
                    ...
                    <p>Очень часто приходится спокойно подумать над дальнейшими действиями (когда "встрял", например) -
                        это
                        бесплатно.</p>
                </div>
            </div>
            ...
            <div class="description video ui stackable two column grid">
                <div class="column text">
                    ...
                    <p>
                        К примеру, часовое видео с моего рабочего экрана 27 дюймов занимает 119 Мегабайт. В один рабочий
                        день
                        обычно получается до 5 часов непосредственной работы над определенными заранее задачами.
                    </p>
                </div>
            ...
            <div class="description speed ui stackable two column grid">
                ...
                <div class="column text">
                    <p>
                        <strong>Я работаю быстрее и качественнее, чем год назад и так продолжается уже давно</strong>
                    </p>
                    <p>
                        Вот сейчас, например, я уже в своей работе использую: слепой слепой 10-пальцевый метод набора,
                        возможности
                        редактора Vim, IDE PhpStorm и множество дургих мощнейших инструментов.
                    </p>
                    <p>
                        А так же большинство стандартных задач в своей практике я уже решил и у меня на многое есть
                        шпаргалки,
                        готовые куски кода с комментариями.
                    </p>
                    <p>
                        Еще в командах, зачастую, нужно много дополнительного времени, чтобы дизайнер ругался с
                        фронтендером,
                        фронтендер с бэкендером и так далее рандомно и бесконечно. У меня сейчас даже внутри только одна
                        личность.
                    </p>
                </div>
            </div>
            ...
            <div class="description total ui stackable two column grid">
                <div class="column text">
                    ...
                    <p>За 100 000 рублей я смогу сделать рабочий сайт решающий поставленные задачи, например
                        ...
                        дизайном на базе
                        Semantic UI, Twitter Bootstrap или Bourbon.io</p>

                    <p>Работаю поэтапно, каждый этап - это выполненная до конца какая-либо задача, понятная профильному
                        программисту.</p>
                </div>
                <div class="column img">
                    <div class="img large computer widescreen largescreen only"></div>
            ...
            <div class="description greed ui stackable two column grid">
                ...
                <div class="column text">
                    ...
                    <p>Деньги есть у всех обычных людей, но их нельзя есть, на них можно только покупать. Чем обычнее и
                        зауряднее
                        человек - тем сильнее он помешан на деньгах.</p>

                    <p>Сайты моего уровня могут разработать и реализовать лишь доля процента людей по всему миру.</p>

                    <p>Если вы верите в сайты за 15000 рублей, то ответьте на вопрос: почему пластиковая модель авто
                        стоит
                        намного
                        дешевле настоящего автомобиля, хотя у нее тоже есть лобовое стекло, колеса и вообще она выглядит
                        как
                        настоящая?</p>
                </div>
            </div>
