...
@section('content')
  <div class="ui page container" id="price">
    ...
    <div class="notice">
      <em>* При условии найма нормального программиста заказчиком из России, это - честная цена. Для западного заказчика - это демпинговая цена. И я - ненормальный программист.</em>
    </div>
      ...
      <div class="description total ui stackable two column grid">
        <div class="column text">
          ...
          <p>За 100 000 рублей я смогу сделать рабочий сайт решающий поставленные задачи, например
            ...
            дизайном на основе
            <a href="https://semantic-ui.com/">Semantic UI</a> или <a href="https://getbootstrap.com/">Twitter Bootstrap</a></p>
