                            ...
                            <g id="arrows" transform="translate(74.000000, 2.000000)">
                              <g id="minute-arrow" transform="rotate(0, 6, 78)"
                                ...
                                <use fill="black" fill-opacity="1" filter="url(#filter-26)"
                                     xlink:href="#path-25" xlink:href="#path-25"></use>
    ...
    <div id="price-descriptions">
      ...
      <div class="description greed ui stackable two column grid">
        ...
        <div class="column text">
          ...
          <p>Если ты веришь в сайты за 30000 рублей, то ответь на вопрос: почему сигнальный пистолет стоит намного
            дешевле боевого, хотя он тоже громко шмаляет и выглядит как настоящий?</p>

          <p>Если ты не веришь, что можно сделать очень качественный сайт очень быстро, заплатив сейчас чуть больше и жить потом спокойно
            и весело, то плати и дальше много, постоянно и до бесконечности как ты привык это делать, а мне мозги не
            компостируй. По делом тебе, скряга!</p>
        </div>
      </div>
