    ...
    <div class="ui page container" id="index">
        ...
        <ol>
            <li>Создание полнофункциональных прототипов сайтов. В современных реалиях часто дизайн, юзабилити и
                функциональность необходимо определять не гадая заранее, а уже в процессе работы бизнеса, по
                сплит/мульти
                тестам.
                Я могу сделать простейший сайт, запустить его и затем дорабатывать, проверяя увеличились ли, например,
                продажи
                из-за
                следующей доработки или был выбран неверный шаг. Таким образом можно очень быстро видеть результат и в
                итоге
                получать очень конверсионные сайты.
            </li>
