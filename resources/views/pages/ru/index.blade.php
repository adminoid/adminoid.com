...
@section('content')
  <div class="ui page container" id="index">
    ...
    <ol>
      ...
      <li><strong>Переделывание устаревшего сайта</strong>, который, например, слишком медленнен и дорог в обслуживании. В данном
        случае,
        в основу
