  ...
  <div class="ui page container" id="index">
    ...
    <ol>
      <li><strong>Создание полнофункциональных прототипов сайтов</strong>.
        В web-разработке складываются определенные стандарты юзабилити и дизайна, к которым привыкли пользователи. Эти стандарты определяют лидеры Интернет-бизнеса (социальные сети, поисковики, популярные сервисы). И эти стандарты отражаются в популярных css-фреймворках, например
        <a href="http://getbootstrap.com/">twitter bootstrap</a>, который создает группа профессионалов мирового уровня. Любое необдуманное нововведение в дизайне может негативно отразиться в конверсии web-приложения, поэтому в современном Интернет-маркетинге любые нововведения подвергаются сплит/мульти-тестам.
        <br>
      ...
      <li><strong>Разработка Интернет-магазинов, интегрированных систем, порталов и любых других сайтов под ключ</strong>.
        ...
        <ul>
          ...
          <li>пишу код соответственно общепринятым стандартам, комментирую, документирую его,
            именую
            развернуто.
            По возможности не изобретаю велосипеды, если есть проверенные людьми во времени решения, у которых
            есть
            документация,
