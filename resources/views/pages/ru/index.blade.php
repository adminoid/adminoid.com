  ...
  <div class="ui page container" id="index">
    ...
    <ol>
      <li><strong>Создание полнофункциональных прототипов сайтов</strong>.
        В web-разработке складываются определенные стандарты юзабилити и дизайна, к которым привыкли пользователи. Эти стандарты определяю лидеры Интернет-бизнеса (социальные сети, поисковики, популярные сервисы). И эти стандарты отражаются в популярных css-фреймворках, например
