            ...
            <div class="ui segment review">
                <div class="ui container">
                    <h2 class="ui header">
                        ...
                        {{ $review->pageable->name_en }} <span class="nick">[<a href="{{ $review->pageable->link_to_profile }}">{{ $review->pageable->nick }}</a>]</span>
                    </h2>
                    <div class="review-text">
                        <p>{!! $review->pageable->content_en !!}</p>
                    </div>
                    ...
                    <div class="ui bottom right attached label"><i
                                class="linkify icon"></i><a href="{{ $review->pageable->link_to_review }}" class="right floated">Link to original</a></div>
                </div>
            </div>
        @endforeach

        <p>Reviews taken from: <a href="https://www.fl.ru/users/adminoid/opinions/">https://www.fl.ru/users/adminoid/opinions/</a></p>
