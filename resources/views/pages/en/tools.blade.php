                    ...
                    <div class="ui segment block sixteen wide column" id="backend">
                        <div class="ui stackable grid">
                            <div class="ten wide column text-wrapper">
                                ...
                                I am developing a backend with <a href="#php" class="hover php">php</a> using the <a href="#laravel" class="hover laravel">Laravel</a> Framework (in <a href="#php-storm" class="hover php-storm">PhpStorm</a> IDE and through <a href="#php-unit" class="hover php-unit">PHPUnit</a> TDD)
                    ...
                    <div class="ui segment block sixteen wide column" id="frontend">
                        <div class="ui stackable grid">
                            <div class="ten wide column text-wrapper">
                                ...
                                <h3>html, css</h3>
                                For html I prefer use PUG. I describe html styles with <a href="#less" class="hover less">LESS</a> or <a href="#sass" class="hover sass">SCSS/SASS</a>.
                                <br>
                                I build only responsive html layouts. Mostly I have worked with <a href="#twitter-bootstrap" class="hover twitter-bootstrap">Twitter Bootstrap</a>, but for this site I have used <a href="#semantic-ui" class="hover semantic-ui">semantic-ui</a>.

                                <h3>Javascript</h3>

                                For programming in javascript I prefer use latest version of <a href="#ecma-script" class="hover ecma-script">ECMAScript</a> and Typescript. For basis I always use <a href="#vue-js" class="vue-js hover">Vue.js</a>. As a module builder I use <a href="#webpack" class="hover webpack">webpack</a>. Also I know and use <a href="#node-js" class="node-js hover">Node.js</a>. I cover code by unit tests with: <a href="#chai" class="hover chai">chai</a>, <a href="#mocha" class="mocha hover">mocha</a>,
                                <a href="#karma" class="hover karma">karma</a> and so on.
                            </div>
                            <div class="six wide column images-wrapper">
                    ...
                    <div class="ui segment block sixteen wide column" id="administration">
                        <div class="ui stackable grid">
                            <div class="ten wide column text-wrapper">
                                ...
                                In recent years I have used OS <a href="#ubuntu" class="hover ubuntu">Ubuntu</a> / <a href="#debian" class="hover debian">Debian</a> (in childhood I use FreeBSD). As a web server I have used <a href="#nginx" class="hover nginx">Nginx</a>, Caddy (In childhood - <a href="#apache" class="hover apache">Apache</a>).

                                And now, using <a href="#docker" class="hover docker">Docker</a>, I can install different versions of backend services at the same time.

                                I use docker-composer, docker-swarm, docker-machine and so on. System based on docker possible transfer to other hardware in minutes.
                    ...
                    <div class="ui segment block sixteen wide column" id="environment">
                        <div class="ui stackable grid">
                            <div class="ten wide column text-wrapper">
                                ...
                                Also I may use either Toggl or <a href="#vitamin" class="hover vitamin">Vitamin-R2</a> or Screenflow (if you need video reports) as a timer. For GTD I may use <a href="#omni" class="hover omni">OmniFocus</a> and other GTD soft.
                            </div>
                            <div class="six wide column images-wrapper">
